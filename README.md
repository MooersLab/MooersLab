...
I think that it might be easier for computer programmers to adopt typst than nonprogrammers.
Writers who are not computer programmers are still going to have a much easier time mastering Markdown.
The next step in markup systems will probably still be the LyX editor, which offers a `what you see is what you get` approach.
Typst is an exciting project that is worth watching, but that is too early to adopt for all of my writing workflows
